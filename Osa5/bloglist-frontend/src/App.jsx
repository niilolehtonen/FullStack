...
const App = () => {
  ...
  useEffect(() => {
    blogService.getAll().then(blogs => {
      const sorteBlogs = blogs.sort((blog1, blog2) => blog2.likes - blog1.likes)
      setBlogs(sorteBlogs)
    })
  }, [])
  ...
  const handleLike = async (blog) => {
    try {
      ...
      setBlogs(blogs.map((b) => b.id === updatedBlog.id ? updatedBlog : b).sort((blog1, blog2) => blog2.likes - blog1.likes))
    } catch (exception) {
